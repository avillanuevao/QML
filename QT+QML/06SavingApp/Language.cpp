...
{
    m_spanish[Vocabulary::DepositWord] = "Deposito";
    m_spanish[Vocabulary::WithdrawalWord] = "Extraccion";
...
{
    m_english[Vocabulary::DepositWord] = "Deposit";
    m_english[Vocabulary::WithdrawalWord] = "Withdrawal";
